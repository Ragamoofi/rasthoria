// cannon-es 0.20.0, MIT. CommonJS distribution wrapped for local classic-script use.
(function(exports){
const require = name => { if (name === "perf_hooks") return { performance: window.performance }; throw new Error("Unsupported dependency: " + name); };
'use strict';
